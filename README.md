...
How to use it
Open index.html to get to the home menu.
Click into the Draft Tracker to follow (or plan for) your draft. Hit Sync from Sleeper to pull in real picks, or paste a different league's link under "League" to load a different draft entirely.
Pick your own team from the Viewing as dropdown — everyone in the league can do this independently, and it only affects what you personally see.
Once the draft wraps up, head to the Season Tracker for standings, trades, and the waiver wire. Hit Sync from Sleeper there too to pull live results once games start.
...
What's next
A "News Room" page (injury updates, headlines) is planned
